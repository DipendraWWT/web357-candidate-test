...
/**
 * Methods supporting a list of Web357test records.
 *
 * @since  1.0.0
 */
class RecipesModel extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		if (!Factory::getApplication()->getIdentity()->authorise('core.edit', 'com_web357test'))
		{
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(Text::_("COM_WEB357TEST_SEARCH_FILTER_DATE_FORMAT"), "warning");
